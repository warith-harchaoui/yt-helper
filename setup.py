...
install_requires = \
['audio-helper @ git+https://github.com/warith-harchaoui/audio-helper.gitv1.0.0',
 'ffmpeg-python>=0.2.0,<0.3.0',
 'os-helper @ git+https://github.com/warith-harchaoui/os-helper.gitv1.0.0',
 'video-helper @ git+https://github.com/warith-harchaoui/video-helper.gitv1.0.0',
